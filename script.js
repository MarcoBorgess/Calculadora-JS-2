class Calculator {
    ...
    chooseOperation(operation) {
        //EVITAR LIMPAR APÓS CLICAR EM OP
        if (this.currentOperand === '') return
        //PERMITIR SEGUNDA OPERAÇÃO
    ...
    compute() {
        ...
        //não permitir calcular sem digitar algum numero
...
const previousOperandTextElement = document.querySelector('[data-operador-antigo]')
